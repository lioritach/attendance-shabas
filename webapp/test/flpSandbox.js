		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "AttendanceShabas",
									"targetURL": "#attendanceshabasattendanceshabas-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"attendanceshabasattendanceshabas-display": {
								"semanticObject": "attendanceshabasattendanceshabas",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=attendanceshabas.attendanceshabas",
									"url": sap.ui.require.toUrl("attendanceshabas/attendanceshabas")
								}
							}
						}
					}
